...
<div class="row">
	...
	<?php 
			$this->renderPartial('problem/_loadProblemGeneral',array('problem'=>$problem,'indexNo'=>$iterator, 'contest'=>$model));
			$this->renderPartial('problem/_loadAnswerGeneral',array('problem'=>$problem,'indexNo'=>$iterator, 'contest'=>$model,'fileForm'=>$fileForm,'submission'=>(isset($submissions[$problem->id]))?$submissions[$problem->id]:null));
	?>
	</div>
	</div>
</div>
